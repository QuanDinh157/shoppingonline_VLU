...
// ĐÃ THÊM: Import EmailUtil để xử lý tác vụ gửi thư
...
router.put(
  ...
  async function (req, res) {
    ...
    // Số 0 ở đây thường tượng trưng cho trạng thái 'deactive' (ngừng hoạt động)
...
// =========================================================
// ĐÃ THÊM: API gửi email kích hoạt cho khách hàng
// =========================================================
router.get(
